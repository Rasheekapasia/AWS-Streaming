    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:kinesis:${var.region}:${data.aws_caller_identity.current.account_id}:stream/${aws_kinesis_stream.kinesis_stream.name}"
        },
        {
          "Effect": "Allow",
          "Action": [
          ...
          "Resource": [       
                "arn:aws:s3:::bucket-firehose-ver1",
                "arn:aws:s3:::bucket-firehose-ver1/*"                         
            ]
        },
        {
